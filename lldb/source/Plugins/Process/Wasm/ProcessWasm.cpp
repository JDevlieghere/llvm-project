...
llvm::Error ProcessWasm::GetWasmLocal(int frame_index, int index, void *buf,
  ...
  return llvm::createStringError("invalid response for qWasmLocal");
}

llvm::Error ProcessWasm::GetWasmGlobal(int frame_index, int index, void *buf,
                                       size_t buffer_size, size_t &size) {
  StreamString packet;
  ...
  return llvm::createStringError("invalid response for qWasmGlobal");
}
