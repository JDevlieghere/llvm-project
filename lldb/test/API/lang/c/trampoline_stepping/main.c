...
__attribute__((debug_trampoline)) void bar(void) { foo(); }

__attribute__((debug_trampoline)) void baz(void) { bar(); }

__attribute__((nodebug)) void nodebug(void) {}

__attribute__((debug_trampoline)) void nodebug_then_trampoline(void) {
  nodebug();
  baz();
}

__attribute__((debug_trampoline)) void doesnt_call_trampoline(void) {}
